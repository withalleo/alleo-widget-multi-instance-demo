...
import { AbstractControl, AsyncValidatorFn, FormArray, FormGroup, FormGroupDirective, NgControl, ValidatorFn } from '@angular/forms'
 ...
 * See {@link https://semver.npmjs.com/}
 *
 * @TJS-format semver
 */
...
export interface IWidgetEntrypoint {
    /**
     * {@link SemverRange | Range} where this entrypoint is valid
     */
    range: SemverRange;
    /**
    ...
    /**
     * Entrypoint priority, if there are any overlaps in the {@link range | ranges}
     ...
     * using the {@link IWidgetBaseManifest.entrypoints | entrypoints} list order.
     */
    priority?: number;
}
export interface IWidgetBaseManifest {
    /**
     * Widget name
     */
    name: string;
    ...
    license?: string;
    /**
     * Current widget {@link Semver | version} (to be used when creating new widgets).
     * Note that at least one {@link entrypoints | entrypoint} must match this version.
     */
    version: Semver;
    /**
...
export interface IWidgetServiceManifest extends Omit<IWidgetBaseManifest, "width" | "height"> {
    /**
...
export type IWidgetManifest = IWidgetBaseManifest | IWidgetServiceManifest;
...
export enum BoardClipboardMimeType {
...
export declare class Utils {
    ...
    static isApiErrorHttpStatusCode(err: any, code: number): boolean;
    static isApiErrorCode(err: any, code: ApiResponseErrorCode, subCode?: any): boolean;
    static isApiError(err: any): boolean;
    static isUrlAbsolute(url: string): boolean;
    static isJson(str: string): boolean;
    static clone<T>(obj: T): T;
    static deepMap(obj: any, iterator: (v: unknown, fullKey: string, obj: unknown, key: string) => unknown, accumulatedKey?: string, context?: any): unknown;
    static deepMapNoArray(obj: any, iterator: (v: unknown, fullKey: string, obj: unknown, key: string) => unknown, accumulatedKey?: string, context?: any): unknown;
    ...
    static calculateAspectRatioFit(srcWidth: any, srcHeight: any, targetWidth: any, targetHeight: any, cover?: boolean): {
        width: number;
        height: number;
    };
    static calculateAspectRatio(srcWidth: any, srcHeight: any, targetWidth: any, targetHeight: any, cover?: boolean): number;
    ...
    static getPasteAsString(item: DataTransferItem | Blob): Promise<{
        type: string;
        data: string;
    }>;
    static escapeHTML(str: any): string;
    static writeClipboardText(text: string, successNotification?: string): Promise<boolean>;
    private static boardClipboardMimeTypeToDataPrefix
    static writeClipboardData(item: ClipboardItem | Partial<{
        "image/png": Blob;
        "text/plain": string;
        "text/html": string;
    } & Record<BoardClipboardMimeType, string | Blob | any | any[]>>, successNotification?: string): Promise<boolean>;
    static readClipboardTextData(type?: string | BoardClipboardMimeType): Promise<any>;
    ...
    private static abortGettingAudioContexts$
...
export type FormlyDialogModel = Record<string, any>;
...
export type BoardObjectExtraDataPayload = BoardObjectVoteExtraData | BoardObjectVisibilityToggleStateExtraData | BoardObjectReactionsExtraData;
...
declare abstract class NetworkCommandBase {
    encoding: "utf8" | "hex"
    port: number
    ip: string
    body: string
...
export declare class UDPCommandPayload extends NetworkCommandBase {
    target: "UDP"
}
export declare class TCPCommandPayload extends NetworkCommandBase {
    target: "TCP"
}
declare abstract class HTTPCommandPayloadBase {
    target: "HTTP"
    method: "GET" | "HEAD" | "POST" | "PUT" | "DELETE" | "CONNECT" | "OPTIONS" | "TRACE" | "PATCH"
    url: string;
    [key: string]: any;
}
export declare class GetCommandPayload extends HTTPCommandPayloadBase {
    method: "GET"
}
export declare class PostCommandPayload extends HTTPCommandPayloadBase {
    method: "POST"
    body: string
}
export declare class PutCommandPayload extends HTTPCommandPayloadBase {
    method: "PUT"
    body: string
}
export type HTTPCommandPayload = GetCommandPayload | PostCommandPayload | PutCommandPayload;
...
export interface IBoardUser {
    ...
    /**
     * Current user profile, the values iside {@link profile} are preferred over {@link name} and {@link imageUrl}
     * as it is updated on change while the other 2 are not
     */
    readonly profile: PartialUserProfile;
    /**
     * {@link Observable} that emits whenever the user's {@link profile} changes
    ...
    /**
     * {@link Observable} that emits whenever {@link permission} changes
     */
    readonly permission$: Observable<BoardMemberPermission>;
    /**
     * Whether the user can modify content on the board, note that for {@link BoardMemberPermission.Contributor}
     * users this will be true however they can only interact with the board in a limited capability
     */
    readonly canEdit: boolean;
    /**
     * {@link Observable} that emits whenever {@link canEdit} changes
     */
    readonly canEdit$: Observable<boolean>;
    /**
     * Describes the user's viewport position in the canvas
     */
    readonly canvasProperties: Partial<CanvasPropertiesUpdateDto> | null;
    /**
     * {@link Observable} that emits whenever {@link canvasProperties} changes
     */
    readonly canvasProperties$: Observable<Partial<CanvasPropertiesUpdateDto> | null>;
    /**
     * Describes the user's cursor position
     */
    readonly cursorPos: Partial<CursorPosUpdateDto> | null;
    /**
     * {@link Observable} that emits whenever {@link cursorPos} changes
     */
    readonly cursorPos$: Observable<Partial<CursorPosUpdateDto> | null>;
}
...
export type IPosition = Position | MapPosition;
export interface IWidgetBoardAssets {
    ...
    /**
     * Show selection dialog for {@link FileSystemNodeClassifier.Image} and load the selected file into a {@link HTMLImageElement}
     */
     ...
     * @param file
     */
    uploadFile(file: File): Promise<StorageNodeCreatedResponseDto | null>;
    /**
...
export interface IWidgetBoardMeeting {
    ...
    /**
     * {@link Observable} that emits whenever {@link activeSpeaker} changes
     */
...
export interface IContainerCreateData extends Omit<IObjectCreateDataBase, "addToContainerId"> {
    title?: string;
}
export interface IImageCreateData extends IObjectCreateDataBase {
    file?: File | string;
}
export interface IVideoCreateData extends IObjectCreateDataBase {
    file?: File;
    fileId?: string;
}
...
export interface IDocumentCreateData extends IObjectCreateDataBase {
    file?: File;
    fileId?: string;
}
export type IWidgetCreateData = ICollaborativeNotepadCreateData;
export type IObjectCreateData = IStickyNoteCreateData | ITextCreateData | IContainerCreateData | IScreenShareCreateData | ILiveVideoCreateData | IImageCreateData | IVideoCreateData | ISlideCreateData | IDocumentCreateData | IWidgetCreateData;
export interface IWidgetBoardObjects {
    ...
    create(type: BoardFabricObjectType.Video, object: IVideoCreateData): Promise<IBoardObject>;
    ...
    create(type: BoardFabricObjectType.Document, object: IDocumentCreateData): Promise<IBoardObject>;
...
export interface IWidgetBoardApi {
    ...
    /**
     * {@link Observable} that emits whenever a user joined the session
     */
    readonly userJoined$: Observable<UserDto>;
    /**
     * {@link Observable} that emits whenever a user left the session
     */
    ...
    /**
     * {@link Observable} that emits when {@link presentationActive} changes
     */
    ...
    /**
     * {@link Observable} that emits when {@link followingUser} changes
     */
    ...
    /**
     * {@link Observable} that emits when {@link leadingUsers} changes
     */
    ...
    /**
     * {@link Observable} that emits when {@link viewOnly} changes
     */
    readonly viewOnly$: Observable<boolean>;
    /**
     * {@link Observable} that emits when the viewport is changed
     */
    readonly viewportChanged$: Observable<{
        animation?: boolean;
    }>;
    /**
     * {@link Observable} that emits when the viewport is panned
     */
    readonly viewportPanned$: Observable<{
        animation?: boolean;
    }>;
    /**
     * {@link Observable} that emits when the viewport is zoomed
     */
    readonly viewportZoomed$: Observable<{
        animation?: boolean;
    }>;
    /**
     * {@link Observable} that emits when board font configuration is changed or initially subscribed
     */
    ...
    /**
     * {@link Observable} Get the board members, including offline users
     */
...
export interface IRoomProxyResultError {
    readonly exception?: any;
    readonly message: any;
}
export interface IRoomProxyResult {
    readonly result?: any;
    readonly error?: IRoomProxyResultError;
    readonly hasError: boolean;
}
export interface IWidgetRoomProxy {
    /**
     * Indicates whether the proxy is available
     */
    readonly isAvailable: boolean;
}
export interface IWidgetRoomLocalProxy extends IWidgetRoomProxy {
    /**
     * Executes an HTTP request on the Room client
     *
     * @param command
     */
    http(command: HTTPCommandPayload): Promise<IRoomProxyResult>;
    /**
     * Executes a TCP request on the Room client
     *
     * @param command
     */
    tcp(command: TCPCommandPayload): Promise<IRoomProxyResult>;
    /**
     * Executes a UDP request on the Room client
     *
     * @param command
     */
    udp(command: UDPCommandPayload): Promise<IRoomProxyResult>;
}
export interface IWidgetRoomRemoteProxy extends IWidgetRoomProxy {
    /**
     * Executes an HTTP request on the Room client
     *
     * @param command
     * @param roomId
     */
    http(command: HTTPCommandPayload, roomId: string): Promise<IRoomProxyResult>;
    /**
     * Executes a TCP request on the Room client
     *
     * @param command
     * @param roomId
     */
    tcp(command: TCPCommandPayload, roomId: string): Promise<IRoomProxyResult>;
    /**
     * Executes a UDP request on the Room client
     *
     * @param command
     * @param roomId
     */
    udp(command: UDPCommandPayload, roomId: string): Promise<IRoomProxyResult>;
}
...
export interface IWidgetRoomApi {
    /**
     * Remote Room Proxy API
     */
    readonly remoteProxy: IWidgetRoomRemoteProxy;
    /**
     * Local Room Proxy API
     */
    readonly localProxy: IWidgetRoomLocalProxy;
    /**
     * Get all displays in the current user's organization
     */
    getDisplays(): Promise<IRoomDisplay[]>;
}
...
export type ContextMenuIconOrImage = ContextMenuIcon | {
    url: string;
};
...
export type ContextMenuButtonDefinition = ContextMenuButton | ContextMenuSubmenu | ContextMenuDropdown | ContextMenuColor | ContextMenuFont;
...
export interface Interactibility {
    /**
     * The default interactibility state for a widget, it is computed as follows from values in {@link state}
     * ```typescript
     * return (
     *    !state.transforming &&
     *    !state.multiSelected &&
...
export interface IWidgetApi {
     ...
     * cleaned up on removal by subscribing to {@link widgetDestroyed$}
     */
    ...
    /**
     * Same as {@link serverTime} but in milliseconds
     */
    ...
    /**
     * Same as {@link requireModule} but takes any number of arguments and returns an array
    ...
    destroy(): void;
    /**
     * An {@link Observable} that emits when the widget is being destroyed, either by calling {@link destroy} or externally
     */
    ...
    /**
     * Set the widget's minimum dimensions (for resieable widgets, see {@link enableResizing})
     *
     * @param width number
     * @param height number
     */
    ...
    /**
     * Set the widget's position based on geographical coordinates, only for map boards (see {@link IWidgetBoardApi.isMap})
     *
     * @param lon longitude
     * @param lat latitude
     */
    ...
    /**
     * Get the widget's position based on geographical coordinates, only for map boards (see {@link IWidgetBoardApi.isMap})
     */
    getPositionLonLat(): {
        lon: number;
        lat: number;
    ...
    /**
     * {@link Observable} that emits whenever the widget data is changed
     */
    readonly dataChanged$: Observable<Record<string, any>>;
    /**
     * Get an {@link Observable} that fires only when a specific field changes
     *
     * @param field fieldname
    ...
    /**
     * An {@link Observable} that emits whenever the widget's interactibility should be updated.
     ...
     * ```
     *
     * The default value of {@link Interactibility.interactible} is computed for you and should fit most use cases.
     */
    readonly interactibility$: Observable<Interactibility>;
    /**
     * Contains last state from {@link IWidgetApi.interactibility$} observable.
     */
    ...
    /**
     * {@link Observable} that emits whenever {@link locked} changes
     */
    ...
    /**
     * {@link Observable} that emits whenever {@link selected} changes
     */
    ...
    /**
     * {@link Observable} that emits whenever {@link multiSelected} changes
     */
    ...
    /**
     * {@link Observable} that emits whenever {@link inViewport} changes
     */
    ...
    /**
     * Emits when {@link transforming} changes
     */
    readonly transforming$: Observable<boolean>;
    /**
     * Trigger an action
     *
     * @param actionId one of the `action.id`s listed in {@link actionTriggers}
     */
    triggerAction(actionId: ActionTriggerDefinition["id"]): void;
    /**
     ...
     */
    actionEffects: ActionEffectDefinition[];
    /**
    ...
    /**
     * An {@link Observable} that emits the payload whenever a message from {@link sendMessage} is received
     */
    readonly message$: Observable<WidgetMessageDto>;
    /**
     * Send and store a sync message for all objects linked to this one,
     * the objects don't have to be initialized in other clients like with {@link sendMessage}
    ...
    /**
     * {@link Observable} that emits whenever a sync message is received
     */
    readonly syncMessage$: Observable<ObjectSyncMessageDto>;
    /**
     * {@link Observable} that emits whenever an object is linked to this one (so it will now
     * receive sync messages)
     */
    readonly objectLinked$: Observable<ObjectLinkedNotificationData>;
    /**
     * {@link Observable} that emits whenever an object is unlinked
     */
    readonly objectUnlinked$: Observable<ObjectLinkedNotificationData>;
    /**
     * {@link Observable} that emits whenever this object's links are changed
     */
    ...
    /**
     * {@link Observable} that emits whenever a new extra data entry is created for this object
     */
    readonly extraDataCreated$: Observable<ObjectExtraDataCreatedDto>;
    /**
     * {@link Observable} that emits whenever an extra data entry is modified
     */
    readonly extraDataModified$: Observable<ObjectExtraDataModifiedDto>;
    /**
     * {@link Observable} that emits whenever an extra data entry is removed
     */
